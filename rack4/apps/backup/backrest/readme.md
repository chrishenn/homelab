...
I don't use these backends any more
...
# note that the local folder is being pushed TO filen here
RCLONE_FILEN: |
    . /scripts/deps.sh
    && rclone sync -P
      /mnt/h/filen
