...
SOCIAL_AUTH_OIDC_ENABLED_IDPS: dict[str, Any] = {
    "pocketid": {
        "oidc_url": "https://pocketid.chenn.dev",
        "display_name": "PocketID",
        "display_icon": "https://pocketid.chenn.dev/api/application-images/logo?light=false",
        "client_id": os.getenv("ZULIP_OIDC_CLIENT"),
        "secret": os.getenv("ZULIP_OIDC_SECRET"),
        "auto_signup": True,
    }
}
...
REMOTE_POSTGRES_HOST = 'zulip_pg'
REMOTE_POSTGRES_PORT = '5432'
REMOTE_POSTGRES_SSLMODE = 'prefer'
AUTHENTICATION_BACKENDS = ('zproject.backends.EmailAuthBackend',)
ALLOWED_HOSTS = ["zulip.chenn.dev", "zulip.henn.dev"]
APPLICATION_SERVER_HTTP_ONLY = True
CERTIFICATES = 'self-signed'
CSRF_TRUSTED_ORIGINS = ["https://zulip.chenn.dev", "https://zulip.henn.dev"]
EMAIL_HOST = 'smtp.protonmail.ch'
EMAIL_HOST_USER = 'chris@henn.dev'
EMAIL_PORT = 465
EMAIL_USE_SSL = False
EMAIL_USE_TLS = True
EXTERNAL_HOST = 'zulip.chenn.dev'
JITSI_SERVER_URL = 'meet.jit.si'
MEMCACHED_LOCATION = 'zulip_memcached:11211'
RABBITMQ_HOST = 'zulip_rabbitmq'
RABBITMQ_USER = 'zulip'
...
ZULIP_ADMINISTRATOR = 'christopherpenn1000@gmail.com'
